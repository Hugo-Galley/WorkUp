...
def callLaBonneAlteranceApi(insee,diploma):
    newJob = 0
...
if __name__ == "__main__":
    try:
        ...
        (nbrGetJobsJooble,nbrNewJobsJooble) = callJoobleApi(["Science,IT,IA"], "Paris")
        (nbrGetJobsAdzuna,nbrNewJobsAdzuna) = callAdzunaAPI(["It,Data"],"75000")
        (nbrGetJobsLba,nbrNewJobsLba) = callLaBonneAlteranceApi("75056","7 (Master, titre ingénieur...)")
        cursor.close()
        conn.close()
